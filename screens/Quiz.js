...
export default function Quiz({ navigation }) {
    ...
    return (
      <SafeAreaView style={{ flex: 1, backgroundColor: '#121212' }}>
        ...
        <ScrollView contentContainerStyle={styles.resultContainer}>
          ...
          <Text style={styles.personality}>{personalityTitles[result.top]}</Text>
          <Text style={styles.match}>Compatibility: {result.percentage}%</Text>
          <Text style={styles.facultyMatch}>Recommended Faculty: {matchedFaculty}</Text>
          ...
          <TouchableOpacity
            ...
            onPress={() => {
              ...
              setScores({ ICT: 0, Design: 0, Architecture: 0, Business: 0, Communication: 0 });
              setShowResult(false);
              setSelectedOption(null);
            }}
          >
  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: '#121212' }}>
      <StatusBar barStyle="light-content" backgroundColor="#121212" />
      <ScrollView style={styles.container} contentContainerStyle={{ flexGrow: 1, justifyContent: 'center', paddingBottom: 40 }}>
...
const styles = StyleSheet.create({
  ...
  progressBar: { height: 10, backgroundColor: '#333', borderRadius: 20, marginBottom: 30 },
  progressFill: { height: 10, backgroundColor: '#FFD700', borderRadius: 20 },
  question: { fontSize: 24, fontWeight: 'bold', color: '#fff', marginBottom: 30 },
  optionButton: { backgroundColor: '#2A2C36', padding: 18, borderRadius: 15, marginBottom: 15, borderWidth: 2, borderColor: '#2A2C36' },
  selectedOption: { borderColor: '#FFD700', backgroundColor: '#333' },
  optionText: { color: '#fff', fontSize: 16 },
  resultContainer: { flexGrow: 1, justifyContent: 'center', alignItems: 'center', paddingBottom: 40 },
  resultTitle: { fontSize: 28, fontWeight: 'bold', color: '#FFD700', marginBottom: 20, textAlign: 'center' },
  personality: { fontSize: 22, color: '#fff', marginBottom: 10, textAlign: 'center' },
  match: { fontSize: 18, color: '#ccc', marginBottom: 10, textAlign: 'center' },
  facultyMatch: { fontSize: 18, color: '#FFD700', marginBottom: 30, textAlign: 'center' },
  button: { backgroundColor: '#4A90E2', paddingVertical: 15, paddingHorizontal: 30, borderRadius: 30, marginBottom: 15, alignItems: 'center' },
